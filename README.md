...
With Override Steam on, switching desktop (keyboard/mouse) to gamepad makes
Steam report the Steam Controller disconnected. That is expected: puckctl
has the device. The tray stays the yellow gamepad icon.
